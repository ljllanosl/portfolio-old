      ...
      <article className='flex sm:flex-row flex-col gap-5 items-center justify-center sm:justify-start'>
        ...
        <div className='flex flex-col gap-4 items-center sm:items-start justify-center sm:justify-start'>
          ...
          <span className='flex flex-row gap-4 items-center justify-center sm:justify-start'>
            <a className='flex items-center rounded bg-[#0c151c] transition hover:bg-[#040a0f] text-[#dbdbdb] p-2 hover:no-underline' href='https://www.linkedin.com/in/luisllanoslucas/' target='_blank' rel='noreferrer'>
              <FontAwesomeIcon icon={faLinkedin} size='xl' className='mr-2' />
              Linkedin
            </a>
            <a className='flex items-center rounded bg-[#0c151c] transition hover:bg-[#040a0f] text-[#dbdbdb] p-2 hover:no-underline' href='https://github.com/ljllanosl' target='_blank' rel='noreferrer'>
